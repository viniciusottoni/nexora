...
| **M5** | Segundo estabelecimento | Mai/2027 | Nova loja implantada em ≤ 5 dias úteis |
...
| Sprint | Entrega |
|---|---|
| **S0.1** | Monorepo, CI/CD, Prisma, schema base, RLS, teste de isolamento |
...
| **5 · Escala** | 6 sem | Painel de instalações, provisionamento autoatendido, modelos por tipo de negócio, domínio próprio, atualização do parque | M5 |
